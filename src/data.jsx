...
const DEFAULT_CONTENT = {
  ...
  eventos: {
    ...
    ctaBtn2: { label: 'Escribir un correo', href: 'mailto:contacto@ruahlabs.cl' },
  ...
  checkout: {
    ...
    shippingFees: { std: 4990, express: 9990, pickup: 0 },
  ...
  cta: {
    ...
    primaryCta:   { label: 'Escribir un correo', href: 'mailto:contacto@ruahlabs.cl?subject=Cotización%20RUAH%20LABS' },
    secondaryCta: { label: 'Ver en Instagram',   href: 'https://instagram.com/ruahlabs' },
  },
  footer: {
    wordmark: 'RUAH',
    wordmarkSecret: 'LABS',
...
function migrateContent(c) {
  ...
  if (c.brand) { delete c.brand.adminPasswordHash; delete c.brand.clubPasswordHash; }
  ...
  if (!c.products.categories.find(cat => cat.id === 'c5')) {
    ...
    const entry = { id: 'c5', name: 'Cuadros', slug: 'cuadros' };
    if (idx6 >= 0) c.products.categories.splice(idx6, 0, entry);
    else c.products.categories.push(entry);
  }
